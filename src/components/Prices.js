        ...
        <div className="row">
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Fully veg loaded pizza</h1>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading"> onion Pizza </h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
                ligula. Duis venenatis at eros sed egestas. Mauris rutrum quam
                risus, vel hendrerit dui tempor in.
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading"> chesse Pizza </h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
                ligula. Duis venenatis at eros sed egestas. Mauris rutrum quam
                risus, vel hendrerit dui tempor in.
              </p>
              <p className="price_rs">₹250.00</p>
            </div>
          </div>
